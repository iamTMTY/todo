          ...
          <Modal className="flex items-end" handleClose={() => setAction({type: "default"})}>
            {
              ...
              <AddTodo 
                ...
                setTodo={setTodo} 
                setAction={setAction} 
                className={`bg-white dark:bg-gray-900 w-full md:w-auto p-4 rounded-tr-2xl rounded-tl-3xl h-[80vh] overflow-y-auto overflow-x-hidden ${action.type === "add" ? "animate-modal_height" : ""}`}
              />
            }
            {
              action.type === "view" && 
